...
function websdkready() {
  ...
  var CLIENT_ID = "ep7tXwKoR8yu2Q8krCilmQ";
  /**
   ...
   */
  var CLIENT_SECRET = "rQYYycGsZhvcQgRwQkRd1Z0oHWhsqVDh";
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = cp+"/zoom/startZoom";
  });
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          meetingConfig.sdkKey = CLIENT_ID;
           var cp = sessionStorage.getItem("contextpath");
          var joinUrl = cp+"/zoom/meetingZoom?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
